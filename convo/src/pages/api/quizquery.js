...
export default async function quiz_handler(passage, req, res) {
    const response = await fetch('https://api.gpt4.ai/completion', {
      ...
      body: JSON.stringify({
        prompt: `For a given passage, please create 3 multiple-choice reading comprehension questions. Make sure each question has one distinct correct answer, and three distinct wrong answers. The correct answer should be taken directly from the passage. 
        ...
        An example of a output you generate may be:
        {
