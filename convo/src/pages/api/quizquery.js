...
export default async function handler(passage, req, res) {
  ...
  const completion = await openai.createCompletion({
    ...
    prompt: `For a given passage, please create 2 multiple-choice reading comprehension questions. Make sure each question has one distinct correct answer, and three distinct wrong answers. The correct answer should be taken directly from the passage. 
